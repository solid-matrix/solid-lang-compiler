...
- `spec/spec.md`（v0.1.0）— 稳定参考版本
- `spec/spec2.md`（v0.1.1 草案）— 重写中，核心变化：从"无隐式"转向"safe implicit"，新增 `@explicit`/`@offset` 标注、`ICast` 接口
